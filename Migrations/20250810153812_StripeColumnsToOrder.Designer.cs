...
namespace ShoesStore.Migrations
{
    ...
    [Migration("20250810153812_StripeColumnsToOrder")]
    partial class StripeColumnsToOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoesStore.Entities.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ShoesStore.Entities.Models.Size", b =>
                {
            ...
            modelBuilder.Entity("ProductSize", b =>
                {
                    b.HasOne("ShoesStore.Entities.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShoesStore.Entities.Models.Size", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShoesStore.Entities.Models.Order", b =>
                {
                    b.HasOne("ShoesStore.Entities.Models.User", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ShoesStore.Entities.Models.Product", b =>
                {
                    b.HasOne("ShoesStore.Entities.Models.Category", "Category")
                        .WithMany("Products")
